								...
								<section class="invoice" style="margin: 30px; border: none">
												...
												<div class="row">
																<div class="col-12">
																				<h2 class="page-header">
																								<img src="{{ asset('dist/img/Logo Langit Aksara.png') }}" alt="Confido Logo" width="220">
																				</h2>
																</div>
																<!-- /.col -->
												</div>
												...
												<div class="row invoice-info">
																<div class="col-sm-4 invoice-col">
																				...
																				<br>
																				<address>
																								<strong>Langit Aksara</strong>
																								<br>
																								Jl.Raya Kaliabang No.8, Perwira, Kec. Bekasi Utara, Kota Bks, Jawa Barat 17122<br>
<br>
																								Phone: 081384002161<br>
																								Email: LangitAskara81@gmail.com
																				</address>
																</div>
																<!-- /.col -->
																<div class="col-sm-4 invoice-col">
