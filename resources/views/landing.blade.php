								...
								<div class="container">
												<div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
																<div class="col-md-7 ftco-animate">
																				<h1 class="mb-4">Selamat Datang di Langit Aksara Tour And Travel</h1>
																												...
																												<div class="testimony-wrap py-4">
																																<div class="text">
																																				...
																																				<p class="mb-4">Aplikasi bagus. Pesan tiket untuk traveling saya dan keluarga jadi
																																								gampang. Terima kasih Langit Aksara 🥰
																																				</p>
																												...
																												<div class="testimony-wrap py-4">
																																<div class="text">
																																				...
																																				<p class="mb-4">Aplikasinya cepat dan mudah digunakan. Tidak sulit untuk dimengerti.
																																								Saya rekomendasikan para pencari tiket pesawat untuk menggunakan aplikasi Langit Aksara
																																								ini.</p>
																																				<div class="d-flex align-items-center">
																...
																<div class="col-md pt-5 border-left">
																				<div class="ftco-footer-widget pt-md-5 mb-4">
																								...
																								<div class="block-23 mb-3">
																												<ul>
																																<li><span class="icon fa fa-map-marker"></span><span class="text">Jl. Kaliabang No.8, Perwira, Kec. Bekasi Utara, Kota Bks, Jawa Barat 17122</span></li>
