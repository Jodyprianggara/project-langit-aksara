				...
				<div class="wrapper">
								...
								<aside class="main-sidebar sidebar-dark-primary elevation-4">
												...
												<a href="/dashboard" class="brand-link">
																<img src="{{ asset('dist/img/Logo Langit Aksara.png') }}" alt="Langit aAksara Logo"
																				class="brand-image img-circle elevation-3" style="opacity: .8">
																<span class="brand-text font-weight-light">Langit Aksara</span>
												</a>
								...
								<footer class="main-footer">
												<strong>Langit Aksara &copy; 2022.</strong>
												All rights reserved.
